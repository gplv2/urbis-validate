...
## WARNING: 
THIS TOOL IS COMPLICATED AND A BIT AGED, IN CASE YOU'RE INTERESTED IN PERFECTING IT , GET IN TOUCH WITH ME.  THE MAIN REASON I STOPPED USING IT IS THAT EVEN URBIS ITSELF DOESN'T KNOW HOW TO CORRECTLY SPELL SOME STREET.  THE MAIN ISSUE IS NOT USING ACCENTS ON VOWLS AT THE BEGINNING OF A STREET NAME, FOR EXAMPLE:
