...
## WARNING: 
THIS TOOL IS COMPLICATED AND A BIT AGED, IN CASE YOU'RE INTERESTED IN PERFECTING IT , GET IN TOUCH WITH ME.  THE MAIN REASON I STOPPED USING IT IS THAT EVEN URBIS ITSELF DOESN'T KNOW HOW TO CORRECTLY SPELL SOME STREET.  THE MAIN ISSUE IS NOT USING ACCENTS ON VOWLS ON CAPITALS OR AT THE BEGINNING OF A STREET NAME, FOR EXAMPLE:

Rue de l'Équerre - Winkelhaakstraat' vs 'Rue de l'Equerre - Winkelhaakstraat';

THE LEFT SIDE IS HOW IT'S PUT IN OSM BY GOOD MAPPERS, THE RIGHT SIDE IS HOW IT'S RECORDED IN URBIS DATABASE.

NEEDLESS TO SAY, THIS PRETTY MUCH SUCKS.  THERE IS NO STREETNAME LIST THAT CORRECTLY SPELLS STREETS WITH ACCENTS, CAPITALIZED CORRECTLY ACCORDING TO FRENCH AND DUTCH SPELLING RULES.

IT'S QUITE AMAZING THAT WITH ALL THE MONEY THROWN AT THESE DATABASES (3 IN TOTAL FOR EACH REGION ONE) THEY CAN'T EVEN GET A PROPER STREETNAME LIST OUT THERE. I WILL CREATE ONE FROM THE COMMUNITY INPUT BUT IT'S A SLOW PROCESS.  WHEN IT'S READY WE WILL PUBLISH AND USE IT IN THIS TOOL.
